...
<body>
	...
	<div >
		...
		<h1>Result | SPANISH Chapter 2</h1>
...
if($totalCorrect>0){
    ...
    $existSql=" Select * from scores WHERE username='$username' AND quizid=4";
    $result= mysqli_query($conn, $existSql);
    $numRows= mysqli_num_rows($result);
    if($numRows>0){
      //exists=true;

      $exist1Sql=" UPDATE scores SET score='$Correct' WHERE quizid=4 ";
